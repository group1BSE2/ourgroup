 ...
 * @author john
 */
public class Pick_GeneralNext {
     public static ArrayList<String> pick(String file, int sheetNum, int cellNumber, int rowNum) throws Exception {
        ...
        for (j = rowNum; j < spreadsheet.getLastRowNum() + 1; ++j) {//To loop thru the rows in a sheet
            ...
            cell = row.getCell(cellNumber); //forks are in the eighth column...
            if (cell != null) {
