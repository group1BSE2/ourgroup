...
//		String file = "00Extension/Pairs_fv_mlv.csv";
		String file = "/Users/businge/Documents/000emse2020/00Dataset/cherrypick_np1.csv";
		
		List<String> mlv = CSVReader.pickStr(file, 0, 1);
//		System.out.println(mlv.size());
		
		int ct[] = {0, 3, 6, 9, 12, 15, 18, 21, 24, 27, 30};
		
		
//		for the repos npm_mlv_to_fv
		int start1 = 0, start2 = 5, start3 = 21, start4 = 95, start5 = 97, start6 = 5000, start7 = 6733; 
		int end1 = 5, end2 = 20, end3 = 95, end4 = 97, end5 = mlv.size() , end6 = 6000, end7 = 5040; 
		
		int	start8 = 7584, start9 = 8871, start10 = 9000, start11 = 9500;
    	int	end8 = 8000, end9 = 9000, end10 = 9500, end11 = 10000;
